...
myContract = web3.eth.contract(address=panRouterContractAddress, abi=panabi)

# print('contract', myContract)

# balance = web3.eth.getBalance(sender_address)
# humanReadable = web3.fromWei(balance,'ether')
# print("Wallet Blance: ", humanReadable)

# tx =  myContract.methods.setData(1)
# print('tx', tx)
...
# estimatedGas = myContract.methods.myMethod.estimateGas(
#         {
#             'from ': sender_address,
...
pancakeswap2_txn = myContract.functions.swapExactETHForTokens(
...
# signed_tx = web3.eth.account.signTransaction(pancakeswap2_txn, my_private_key)
...
# transaction = web3.eth.getTransaction('0x82f1da8eda291d3d136aa7d4f1e1ab2c1fe2ea5b0c96e19c291a3212de191b17');
