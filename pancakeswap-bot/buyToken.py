...
from wallet_infor import my_private_key, sender_address, bao_elemon_wallet_address, bao_elemon_wallet_private_key
...
balance = web3.eth.get_balance(bao_elemon_wallet_address)
